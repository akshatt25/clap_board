...
class Dimensions {
  ...
  // static sized box with heights

  static Widget k30Sizedbox = SizedBox(
    height: Dimensions.height30,
  );
  static Widget k60Sizedbox = SizedBox(
    height: Dimensions.height70,
  );
  static Widget k20Sizedbox = SizedBox(
    height: Dimensions.height20,
  );
  static Widget k10Sizedbox = SizedBox(
